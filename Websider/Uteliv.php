...
<html>
	<head>
		<meta charset="UTF-8">
		<link rel="stylesheet" type="text/css" href="../css/uteliv.css">
		<title>Uteliv</title>
	</head>
	<body>
		<header>
		...
		<div class="backgroundImage">
			<div class="content">
				<h1> Uteliv </h1>
				<div id="Jacob_logo"></div>
				<h3 id="Jacob_Aall"> Jacob Aall Restaurant og Bar: </h3>
				<p id="Jacob_text">På toppen av Bergens flotteste kjøpesenter, Xhibition,
				 omgitt av vakre Bergen ligger Jacob Aall Brasserie og Bar Bergen. 
				 Restauranten er perfekt for å kombinere shoppingen med en god lunsj.
				 Store vindusflater lar deg nyte utsikten over Bergen mens dere koser 
				 dere med god mat og drikke. Ønsker du å nyte måltidet og Bergen til det fulle,
				 har vi også en stor helårsåpen takterrasse.
				 Her har vi egen utebar hvor du kan sitte i våre lounger og nyte god drikke i hyggelig
				 selskap i behagelige omgivelser. 
				...
				<div id="Metro_content">
					...
					midt i Bergen sentrum. Vi hadde vårt 10 års jubileum i 2011. 
					Metro har hatt fokus på alltid å ligge lengst mulig fremme når det kommer til 
					design og trend, og har derfor vært oppgradert jevnlig, senest i 2011.
				...
				<div id="Lysverket_content">
					...
					KODE 4 ved Grieghallen - midt i hjertet av Bergen med utsikt over Rasmus Meyers Allé, Lille Lungegårdsvannet, 
					Festplassen, fjellsiden og Fløyen.
					Som spisested er Lysverket en tydelig bergensrestaurant med fokus på fersk sjømat - 
